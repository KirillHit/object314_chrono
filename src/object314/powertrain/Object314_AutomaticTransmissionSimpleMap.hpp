...
#ifndef OBJECT314_AUTOMATIC_TRANSMISSION_SIMPLEMAP_HPP
#define OBJECT314_AUTOMATIC_TRANSMISSION_SIMPLEMAP_HPP
...
class CH_MODELS_API Object314_AutomaticTransmissionSimpleMap : public ChAutomaticTransmissionSimpleMap {
  public:
    Object314_AutomaticTransmissionSimpleMap(const std::string& name);
    ~Object314_AutomaticTransmissionSimpleMap() {}
