...
// Static variables
const double Object314_EngineSimple::m_max_torque = 2400;
const double Object314_EngineSimple::m_max_power = 530000;
const double Object314_EngineSimple::m_max_speed = 10000;
