// Object314 engine model based on ChShaft objects. Engine data unknown,
// MROLE engine used instead (similar power/torque/speed characterristcs)

#include "Object314_EngineShafts.hpp"
...
// Static variables
const double Object314_EngineShafts::m_motorblock_inertia = 10.5;
const double Object314_EngineShafts::m_motorshaft_inertia = 2.1;

Object314_EngineShafts::Object314_EngineShafts(const std::string& name) : ChEngineShafts(name, ChVector3d(1, 0, 0)) {}

void Object314_EngineShafts::SetEngineTorqueMap(std::shared_ptr<ChFunctionInterp>& map) {
...
void Object314_EngineShafts::SetEngineLossesMap(std::shared_ptr<ChFunctionInterp>& map) {
    double rpm_to_radsec = CH_2PI / 60.;
