...
// Static variables
// -----------------------------------------------------------------------------
const double Object314_TrackShoeSinglePin::m_shoe_height = 0.06;
const double Object314_TrackShoeSinglePin::m_shoe_pitch = 0.17;
const double Object314_TrackShoeSinglePin::m_shoe_mass = 18.02;
const ChVector3d Object314_TrackShoeSinglePin::m_shoe_inertia(0.22, 0.04, 0.25);

const double Object314_TrackShoeSinglePin::m_cyl_radius = 0.015;
const double Object314_TrackShoeSinglePin::m_front_cyl_loc = 0.0535;
const double Object314_TrackShoeSinglePin::m_rear_cyl_loc = -0.061;

const ChVector3d Object314_TrackShoeSinglePin::m_pin_center(0.045, 0, 0.0375);
