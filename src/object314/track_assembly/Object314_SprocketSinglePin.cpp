...
const double Object314_SprocketSinglePin::m_gear_mass = 27.68;
const ChVector3d Object314_SprocketSinglePin::m_gear_inertia(0.646, 0.883, 0.646);
const double Object314_SprocketSinglePin::m_axle_inertia = 0.4;
const double Object314_SprocketSinglePin::m_separation = 0.225;

const double Object314_SprocketSinglePin::m_gear_RT = 0.3;          // Outer radius
const double Object314_SprocketSinglePin::m_gear_RC = 0.328414781;  // Arc centers radius
const double Object314_SprocketSinglePin::m_gear_R = 0.07;          // Arc radius
const double Object314_SprocketSinglePin::m_gear_RA = 0.275;        // Assembly radius

const double Object314_SprocketSinglePin::m_lateral_backlash = 0.01;
